...
4. To upload, use an FTP client, WebFTP, or some tool provided by the hosting.
...
Check our section about web servers to get additional configuration instructions. <a href="https://docs.bludit.com/en/webservers/apache">Apache</a> - <a href="https://docs.bludit.com/en/webservers/nginx">Nginx</a>
</div>
